...
ln -sbf ~/Git/dotfiles/init.vim ~/.config/nvim/
ln -sbf ~/Git/dotfiles/mpd.conf ~/.config/mpd/
ln -sbf ~/Git/dotfiles/plug.vim ~/.local/share/nvim/site/autoload/plug.vim
ln -sbf ~/Git/dotfiles/plug.vim ~/.vim/autoload/plug.vim
